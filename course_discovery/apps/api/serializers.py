...
class CourseSearchSerializer(HaystackSerializer):
    ...
    def get_course_runs(self, result):
        ...
        return [
            ...
            # We do this here, rather than as an additional `.exclude` because the course_runs have been prefetched
            # by the read_queryset of the search index.
            if (not request.GET.get("exclude_expired_course_run") or course_run.end is None or course_run.end > now)
        ]
